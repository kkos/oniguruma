...
static int
exec(UChar* pattern, UChar* str, OnigOptionType options, OnigOptionType runtime_options)
{
  int r;
...
extern int main(int argc, char* argv[])
{
  ...
  exec(pattern, str, ONIG_OPTION_NONE, ONIG_OPTION_CALLBACK_EACH_MATCH);
  exec(pattern, str, ONIG_OPTION_FIND_LONGEST, ONIG_OPTION_CALLBACK_EACH_MATCH);
